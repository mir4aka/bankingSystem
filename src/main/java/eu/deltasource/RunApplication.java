...
public class RunApplication {
    public void run() {
        ...
        BankAccount nikic = new BankAccount(niki4, "frewer", "GBP", 30, "CurrentAccount", "SavingsAccount");
        BankAccount mirkic = new BankAccount(mirki4, "freweer", "USD", 30, "CurrentAccount");
